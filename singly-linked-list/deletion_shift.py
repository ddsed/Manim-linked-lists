...
class LinkedListShiftScene(MovingCameraScene):
    def construct(self):
        ...
        if delete_idx == 0:
            ...
            self.delete_node_tail(list.nodes, delete_idx, list.headtext, list.headarrow)
        else:
            self.delete_node_row(list.nodes, delete_idx, list.headtext, list.headarrow)
