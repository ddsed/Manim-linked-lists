# Tests for insertion into the class with overview of linked list representations
...
from insertion_overview import OverviewScene
...
def test_overview_insert_all_positions(size):
