# Tests for insertion into dynamic chain representation of linked list
...
from insertion_shift import LinkedListShiftScene
...
def test_linked_list_shift_insert_all_positions(size):
