# Tests for deletion from static chain representation of a linked list
...
from deletion_static import LinkedListStaticScene
...
def test_linked_list_static_delete_all_positions(size):
